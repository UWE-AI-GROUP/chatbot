...
public class AB {
    ...
    /**
     * Calculates the botmaster's productivity rate in categories/sec when using
     * Pattern Suggestor to create content.
     *
    ...
    /**
     * read sample inputs from filename, turn them into Paths, and add them to
     * the graph.
     *
    ...
    /**
     * magically suggests new patterns for a bot. Reads an input file of sample
     * data called logFile. Builds a graph of all the inputs. Finds new patterns
     * in the graph that are not already in the bot. Classifies input log into
     * those new patterns.
     *
     *
     *

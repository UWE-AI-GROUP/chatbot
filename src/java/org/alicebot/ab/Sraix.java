    ...
    public static String sraixPannous(String input, String hint, Chat chatSession)  {
        try {
           ...
           // input = chatSession.bot.preProcessor.denormalize(input);
			...
			String url = "https://weannie.pannous.com/api?input="+input+"&locale=en_US&timeZone="+offset+locationString+"&login="+MagicStrings.pannous_login+"&ip="+NetworkUtils.localIPAddress()+"&botid=0&key="+MagicStrings.pannous_api_key+"&exclude=Dialogues,ChatBot&out=json&clientFeatures=show-images,reminder,say&debug=true";

...
public class Main {
    ...
    public static void mainFunction (String[] args) {
        /*## reads in command line arguements for botname, action, trace, morph
        and sets Boolean values in "MagicBooleans" and string values as local variables.
        * Then creates a Bot object and calls make_verbs_sets maps
        */
